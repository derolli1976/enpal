...
# Keys observed on a FoxEss/ControlBox system with firmware 8.51 (issue #148,
# captured live and cross-checked against the Data Collector JSON). Includes
# the rows hidden behind "Show unsupported/internal values". Ambiguous keys
# (Energy.Consumption.Total.Lifetime, Power.AC.Max, SoftwareVersion.Service.2.Fox)
# are deliberately absent.
SENSOR_KEY_GROUPS.update({
    "Battery.ChargeLevel.Max": "Battery",
    "Battery.ChargeLevel.Min": "Battery",
    "Battery.Enable.Disable": "Battery",
    "Battery.Enable.Disable.Internal": "Battery",
    "Battery.Is.Missing": "Battery",
    "Battery.Model.Code": "Battery",
    "Battery.Model.Code.Mapped": "Battery",
    "Battery.Power.Rating.Maximum": "Battery",
    "Battery.SOH": "Battery",
    "ChargePoint.Model": "Wallbox",
    "Code.Device.Type": "Inverter",
    "Command.EMS.Mode": "Battery",
    "Command.Start": "Inverter",
    "Command.Start.Stop": "Inverter",
    "Command.Stop": "Inverter",
    "ControlBox.Eebus.Cert.Expired": "ControlBox",
    "ControlBox.Eebus.Health.Missing": "ControlBox",
    "ControlBox.Eebus.Health.Stale": "ControlBox",
    "ControlBox.Eebus.Status.Disconnected": "ControlBox",
    "ControlBox.Eebus.Status.Discovered": "ControlBox",
    "ControlBox.Eebus.Status.Discovery": "ControlBox",
    "ControlBox.MGCP.Missing": "ControlBox",
    "ControlBox.MGCP.Stale": "ControlBox",
    "ControlBox.MGCP.Unavailable": "ControlBox",
    "Current.Battery.Charge.Max": "Battery",
    "Current.Battery.Discharge.Max": "Battery",
    "Current.String.3": "Inverter",
    "Current.String.4": "Inverter",
    "Current.String.5": "Inverter",
    "Current.String.6": "Inverter",
    "Current.Wallbox.Connector.1.Phase.A.Raw": "Wallbox",
    "Current.Wallbox.Connector.1.Phase.B.Raw": "Wallbox",
    "Current.Wallbox.Connector.1.Phase.C.Raw": "Wallbox",
    "Dongle.BackendConnection": "Inverter",
    "Dongle.SerialNumber": "Inverter",
    "Eebus.CertExpiry": "ControlBox",
    "Eebus.ConnectionState": "ControlBox",
    "Eebus.DiscoveryState": "ControlBox",
    "Eebus.Ski": "ControlBox",
    "Energy.Battery.Capacity": "Battery",
    "Energy.Battery.Charge.Level.Absolute": "Battery",
    "Energy.Battery.Charge.Load": "Battery",
    "Energy.Grid.SMGW.Export.Lifetime": "ControlBox",
    "Energy.Grid.SMGW.Import.Lifetime": "ControlBox",
    "Energy.Inverter.Export.Lifetime": "Inverter",
    "Energy.Inverter.Import.Lifetime": "Inverter",
    "Energy.Wallbox.Connector.1.Charged.Total.Raw": "Wallbox",
    "Inverter.ComsProtocol.Version": "Inverter",
    "Inverter.Modbus.Health.Rtu.Status": "Inverter",
    "Inverter.Modbus.Health.Tcp.Status": "Inverter",
    "Inverter.Power.Phase.A": "Inverter",
    "Inverter.Power.Phase.B": "Inverter",
    "Inverter.Power.Phase.C": "Inverter",
    "Inverter.Power.Rating.Maximum": "Inverter",
    "Inverter.Standby.State.Set": "Inverter",
    "Mode.Battery.Safety.Charge": "Battery",
    "Mode.Forcible.Charge.Discharge": "Battery",
    "Mode.Forcible.Timeout": "Battery",
    "Power.AC.Max.Checked": "Inverter",
    "Power.Battery.Charge.Discharge": "Battery",
    "Power.Battery.Charge.Discharge.Set": "Battery",
    "Power.Battery.Charge.Discharge.Set.Modbus": "Battery",
    "Power.Battery.Charge.Max": "Battery",
    "Power.DC.String.3": "Inverter",
    "Power.DC.String.4": "Inverter",
    "Power.DC.String.5": "Inverter",
    "Power.DC.String.6": "Inverter",
    "Power.Export.Total": "PowerSensor",
    "Power.Grid.SMGW.Active": "ControlBox",
    "Power.Inverter.AC.Export": "Inverter",
    "Power.Limit": "Inverter",
    "Power.Wallbox.Connector.1.Charging.Raw": "Wallbox",
    "Power.Wallbox.Connector.1.Offered.Raw": "Wallbox",
    "SerialNumber.Battery": "Battery",
    "SerialNumber.Battery.Unit.0": "Battery",
    "SerialNumber.Battery.Unit.3": "Battery",
    "SerialNumber.Battery.Unit.4": "Battery",
    "SerialNumber.Battery.Unit.5": "Battery",
    "SerialNumber.Battery.Unit.6": "Battery",
    "SerialNumber.Battery.Unit.7": "Battery",
    "SerialNumber.Battery.Unit.8": "Battery",
    "SoftwareVersion.Service.1": "Inverter",
    "SoftwareVersion.Service.1.Fox": "Inverter",
    "SoftwareVersion.Service.2": "Inverter",
    "SoftwareVersion.Service.Battery.Unit.1": "Battery",
    "SoftwareVersion.Service.Battery.Unit.1.Double": "Battery",
    "SoftwareVersion.Service.Battery.Unit.2": "Battery",
    "State.ErrorCodes.1": "Inverter",
    "State.ErrorCodes.10": "Inverter",
    "State.ErrorCodes.11": "Inverter",
    "State.ErrorCodes.2": "Inverter",
    "State.ErrorCodes.3": "Inverter",
    "State.ErrorCodes.9": "Inverter",
    "State.Wallbox.Connector.1.Charge.Raw": "Wallbox",
    "Status.Wallbox.Connector.1.Raw": "Wallbox",
    "Type.Phase.Inverter": "Inverter",
    "Voltage.String.3": "Inverter",
    "Voltage.String.4": "Inverter",
    "Voltage.String.5": "Inverter",
    "Voltage.String.6": "Inverter",
    "Voltage.Wallbox.Connector.1.Phase.A.Raw": "Wallbox",
    "Voltage.Wallbox.Connector.1.Phase.B.Raw": "Wallbox",
